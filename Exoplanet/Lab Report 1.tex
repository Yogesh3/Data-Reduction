...
\begin{deluxetable*}{ccCrlc}[h!]
	...
	\enddata
	\tablecomments{We expected to take two sets of 800 exposures of the science tansit, however we stopped at around 1,500 exposures due to time. All of the files are .FIT files.}
\end{deluxetable*}
