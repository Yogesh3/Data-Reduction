...
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves1.pdf}
    \caption{Reference star 1. This variable star was removed for the duration of the experiment}
    \label{fig: refcurve1}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves2.pdf}
	\caption{Reference star 2}
	\label{fig: refcurve2}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves3.pdf}
	\caption{Reference star 3}
	\label{fig: refcurve3}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves4.pdf}
	\caption{Reference star 4}
	\label{fig: refcurve4}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves5.pdf}
	\caption{Reference star 5}
	\label{fig: refcurve5}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves6.pdf}
	\caption{Reference star 6}
	\label{fig: refcurve6}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves7.pdf}
	\caption{Reference star 7}
	\label{fig: refcurve7}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves8.pdf}
	\caption{Reference star 8}
	\label{fig: refcurve8}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves9.pdf}
	\caption{Reference star 9. The outliers rendered this star useless.}
	\label{fig: refcurve9}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves10.pdf}
	\caption{Reference star 10. This star was scrapped because of its outliers and large spread}
	\label{fig: refcurve10}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_curves11.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = .85]{exo_lightcurve.pdf}
